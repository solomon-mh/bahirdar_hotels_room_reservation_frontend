  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button className="rounded-md border border-accent-500 bg-[#34343400] px-4 py-1 text-accent-500 hover:bg-accent-500 hover:text-slate-100">
          Create Manager
        </button>
      </DialogTrigger>
      <DialogContent className="max-h-[80vh] min-w-[70vw] bg-slate-200 p-6">
        <DialogHeader>
