  ...
  return (
    <div className="w-full rounded-lg border bg-slate-300 p-4 opacity-85 shadow-lg">
      {activeBooking?.checkInDate && activeBooking.checkOutDate && (
        <div className="m-2">
          <p className="w-full rounded-xl bg-accent-500 p-4 text-center text-xl text-slate-200">
          ...
          <div className="mb-4 flex items-center justify-center">
            <button
              ...
              className="w-full rounded-full bg-accent-500 px-3 py-2 text-xs text-white transition-all duration-200 hover:scale-105"
            >
        ...
        <>
          ...
          >
            ...
            <button
              ...
              className="w-full rounded bg-accent-500 px-3 py-2 text-xl uppercase text-slate-100 shadow-xl disabled:cursor-not-allowed disabled:bg-accent-500"
            >
              Book Room Now
            </button>
          </form>
