      ...
      <div className="flex items-center justify-between p-6">
        ...
        <div className="flex items-center justify-between gap-2">
          <button
            ...
            disabled={activeBtn === ""}
            className="rounded border bg-accent-500 px-3 text-sm text-white transition-all duration-300 disabled:cursor-not-allowed"
          >
            all
          </button>
          <button
            ...
            className="rounded border px-3 text-sm transition-all duration-300 hover:bg-accent-500 hover:text-white disabled:cursor-not-allowed disabled:bg-accent-700 disabled:text-white"
          >
            all users
          </button>
          <button
